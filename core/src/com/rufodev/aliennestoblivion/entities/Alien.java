...
public class Alien extends Entity{
	...
	public Alien(Vector2 position, int health, ArrayList<Sprite> alienImages, float speed, Player player) {
	...
	public Alien(Vector2 position, int health, ArrayList<Sprite> alienImages, float speed, Player player, boolean spawnsRight) {
		super( position,health,width,height,true, spawnsRight);
		super.setSpeed(speed);
		super.animator=new Animator(alienImages, 100);
